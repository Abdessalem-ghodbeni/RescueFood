    ...
    <main>
        ...
        <div class="page-content">
            ...
            <div class="page-content-wrapper p-xxl-4">
                ...
                <div class="card-body">
                    <a href="{{ url('/produit/create') }}" class="btn btn-success btn-sm"
                    ...
                    <div class="table-responsive">
                        @if ($produits->count())
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($produits as $item)
                                        <tr class="{{ $item->livre == 1 ? 'bg-success text-white' : '' }}">
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $item->nom_produit }}</td>
                                            <td>{{ $item->type }}</td>
                                            <td>{{ $item->stock->nom ?? 'N/A' }}</td>
                                            <td>{{ $item->date_expiration }}</td>
                                            <td>{{ $item->livre ? 'Oui' : 'Non' }}</td>
                                            <td>
                                                <a href="{{ url('/produit/' . $item->id) }}" title="Voir le produit">
                                                    <button class="btn btn-info btn-sm">
                                                        <i class="fa fa-eye" aria-hidden="true"></i> Détails
                                                    </button>
                                                </a>

                                                <a href="{{ url('/produit/' . $item->id . '/edit') }}"
                                                ...
                                                <form method="POST" action="{{ url('/produit/' . $item->id) }}"
