...
<link rel="shortcut icon" href="{{asset('layoutsCss/images/az.png')}}">
	...
	<link rel="stylesheet" type="text/css" href="{{asset('restorantCss/vendor/choices/css/choices.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('restorantCss/vendor/aos/aos.css')}}">
