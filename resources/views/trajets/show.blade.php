...
<main>
	...
	<div class="page-content">
		...
		<!-- Page main content START -->
		 <div class="page-content-wrapper p-xxl-4"><div class="container">
            <h1>Détails du Trajet</h1>
            <p><strong>Point de Départ:</strong> {{ $trajet->point_depart }}</p>
            <p><strong>Point d'Arrivée:</strong> {{ $trajet->point_arrive }}</p>
            <p><strong>Durée:</strong> {{ $trajet->duree }} minutes</p>

            <a href="{{ route('trajets.index') }}" class="btn btn-link">Retour à la liste</a>
        </div></div>
