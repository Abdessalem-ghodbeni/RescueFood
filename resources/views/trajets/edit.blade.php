            ...
            <form action="{{ route('trajets.update', $trajet) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="point_depart" name="point_depart"
                           value="{{ $trajet->point_depart }}" required>
                </div>
                <div class="form-group">
                    <label for="point_arrive">Point d'Arrivée:</label>
                    <input type="text" class="form-control" id="point_arrive" name="point_arrive"
                           value="{{ $trajet->point_arrive }}" required>
                </div>
                <div class="form-group">
                    <label for="duree">Durée (min):</label>
                    <input type="number" class="form-control" id="duree" name="duree"
                           value="{{ $trajet->duree }}" required>
                </div>
