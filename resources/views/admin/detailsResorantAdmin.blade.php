				...
				<div class="d-flex align-items-center w-100">
					...
					<div class="d-flex align-items-center d-xl-none">
						<a class="navbar-brand" href="index.html">
							<img class="navbar-brand-item h-40px" src="{{asset('layoutsCss/images/admin.jpg')}}" alt="">
						</a>
					</div>
					<!-- Logo END -->
					...
					<ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
						...
						<li class="nav-item ms-3 dropdown">
							...
							<a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
								<img class="avatar-img rounded-2" src="{{asset('layoutsCss/images/admin.jpg')}}" alt="avatar">
							</a>
								...
								<li class="px-3 mb-3">
									<div class="d-flex align-items-center">
										...
										<div class="avatar me-3">
											<img class="avatar-img rounded-circle shadow" src="{{asset('layoutsCss/images/admin.jpg')}}" alt="avatar">
										</div>
										<div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="bg-light p-4 p-sm-5 rounded-3">
                                <!-- Title -->
                                <h2 class="fs-3 text-center mb-4 mb-sm-5">Ceci plus d'information sur le restorant numéro <strong>{{ $restaurant->id }}</strong> </h2>
                <!-- Card START -->
                <div class="col-12 text-center mb-3">
                    <div class="card card-body p-4">
                        <h5>Nom du restaurant : </h5>
                        <p class="mb-0">Notre établissement porte fièrement le nom de <strong>{{ $restaurant->Restorant }},</strong> </p>
                    </div>
                </div>
                                <div class="row g-4">
                                    <!-- Card START -->
                                    <div class="col-md-6">
                                        <div class="card card-body p-4">
                                         <div><img src="{{asset('layoutsCss/images/element/18.svg')}}" class="h-70px mb-3" alt=""></div> 
                                            <h5>Localisation : </h5>
                                            <p class="mb-0">Niché au cœur de <strong>{{ $restaurant->localisation }},</strong> notre restaurant vous accueille dans un cadre chaleureux.</p>
                                        </div>
                                    </div>
                                    <!-- Card END -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-body p-4">
                                            ...
                                            <p class="mb-0">Fondé le <strong>{{ \Carbon\Carbon::parse($restaurant->created_at)->format('d/m/Y') }},</strong> notre restaurant perpétue une tradition d’excellence depuis.</p>
                                        </div>
                                    </div>
                                    <!-- Card END -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-body p-4">
                                            ...
                                            <h5>Spécialité : </h5>
                                            <p class="mb-0">Notre restaurant est renommé pour sa spécialité, <strong>{{ $restaurant->specialite }} </strong>un véritable délice qui ravit les papilles de nos convives.
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-body p-4">
                                            ...
                                            <h5>Numéro fix</h5>
                                            <p class="mb-0"> Pour toute information ou réservation, contactez-nous au <strong>{{ $restaurant->numero_fix }}</strong></p>
                                        </div>
                                    </div>
                                    <!-- Card END -->
