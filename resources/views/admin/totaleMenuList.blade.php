                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $menu->nom_plat }}</td>
                                <td>{{ $menu->restaurant->Restorant }}</td>
                                <td>{{ $menu->prix }} €</td>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <!-- Bouton Voir Détails -->
                                        <a href="{{ route('admin.showMenu', $menu->id) }}" class="btn btn-info me-2">
                                            <i class="bi bi-info-circle"></i>
                                        </a>
                                        <!-- Bouton Supprimer -->
                                        <form action="{{ route('admin.destroyMenu', $menu->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
