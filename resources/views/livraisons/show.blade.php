    ...
    <main>
        ...
        <div class="page-content">
            ...
            <div class="page-content-wrapper p-xxl-4">
                ...
                <h1 class="text-center mb-4">Détails de la Livraison</h1>

                <div class="list-group">
                    <div class="list-group-item">
                        <h5>Date de Livraison:</h5>
                        <p class="mb-0">{{ $livraison->date_de_livraison }}</p>
                    </div>
                    <div class="list-group-item">
                        <h5>Destination:</h5>
                        <p class="mb-0">{{ $livraison->destination }}</p>
                    </div>
                    <div class="list-group-item">
                        <h5>Numéro de Livraison:</h5>
                        <p class="mb-0">{{ $livraison->numero_livraison }}</p>
                    </div>
                    <div class="list-group-item">
                        <h5>Utilisateur:</h5>
                        <p class="mb-0">{{ $livraison->user->name ?? 'Non spécifié' }}</p>
                    </div>
                    <div class="list-group-item">
                        <h5>Trajet:</h5>
                        <p class="mb-0">{{ $livraison->trajet->name ?? 'Non spécifié' }}</p>
                    </div>
                </div>

                <a href="{{ route('livraisons.index') }}" class="btn btn-link mt-3">Retour à la liste</a>
            </div>
