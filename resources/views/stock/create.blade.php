                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('stock') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="restaurant_id" id="restaurant_id" class="form-control" value="{{ old('restaurant_id') }}" required>
                                    <option value="">Sélectionnez un restaurant</option> <!-- Option par défaut -->
                                    @foreach($restaurants as $restaurant)
                                    <option value="{{ $restaurant->id }}">{{ $restaurant->Restorant }}</option> <!-- Afficher le nom du restaurant -->
                                    @endforeach
                                </select>
