                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->restaurant->Restorant ?? 'N/A' }}</td>
                                    <td>
                                        <a href="{{ url('/stock/' . $item->id) }}" title="View Stock"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Détails</button></a>
                                        <a href="{{ url('/stock/' . $item->id . '/edit') }}" title="Edit Stock"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modifier</button></a>
